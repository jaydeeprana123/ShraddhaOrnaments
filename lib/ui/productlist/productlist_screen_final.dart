...
class ProductListScreen extends StatefulWidget {
  ...
  const ProductListScreen({Key key, this.catId, this.catName})
      : super(key: key);
                    ...
                    child: InkWell(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SvgPicture.asset(isList?grid:list,height: isList?15:20,color: AppTheme.black_text,),
                          SizedBox(width: 6,),
                          Text(isList?"Show In Grid":"Show In List",style: AppTheme.subtitleopensans.copyWith(color: AppTheme.black_text,fontSize: 14, fontWeight: FontWeight.w400)  ,),
                        ],
                      ),
                    ),
                  ),
                                      ...
                                      Stack(
                                        children: [
                                          ...
                                          Align(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                if (_bloc.subject.value
                                                    .data[index].wishlist ==
                                                    Constant.isWishlist) {
                                                  _bloc.subject.value.data[index]
                                                      .wishlist = "0";
                                                  addremoveWishlist(
                                                      false,
                                                      _bloc.subject.value
