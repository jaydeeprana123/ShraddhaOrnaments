...
//                       ),
                    ...
                    // Container(
                    //   margin: EdgeInsets.only(right: 16, bottom: 120),
                    //   child: Align(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        color: selectdImage == index
                                            ...
                                            : AppTheme.off_White,
                                        width: selectdImage == index ? 1 : 0.5,
                                      ),
                          ...
                          InkWell(
                            onTap: (){
                              if (response.data.wishlist ==
                                ...
                                addremoveWishlist(
                                    false, response.data.id.toString());
                              } else {
                                response.data.wishlist = "1";
                                addremoveWishlist(
                                    true, response.data.id.toString());
                              }

                            },
                            child: Image.asset((response.data.wishlist==Constant.isWishlist)?'assets/images/like_active.png':'assets/images/like.png',height: 32,),
                          )
                                  ...
                                  Expanded(
                                    child: Column(
                                      children: [
                                        ...
                                        response.data.sellingType == null
                                            ? Text(
                                                "",
                                                style: AppTheme.subtitleopensans
                                                    .copyWith(
                                            ...
                                            : response.data.sellingType.isEmpty
                                                ? Text(
                                                    "",
                                                    style: AppTheme.subtitleopensans
                                                        .copyWith(
                                      ...
                                      children: [
                                        ...
                                        response.data.department == null
                                          ...
                                          style: AppTheme.subtitleopensans
                                            ...
                                            : response.data.department.isEmpty
                                            ? Text(
                                          "",
                                          style: AppTheme.subtitleopensans
                                              .copyWith(
                                      ...
                                      children: [
                                        ...
                                        response.data.material == null
                                          ...
                                          style: AppTheme.subtitleopensans
                                            ...
                                            : response.data.material.isEmpty
                                            ? Text(
                                          "",
                                          style: AppTheme.subtitleopensans
                                              .copyWith(
                          ...
                          ,children: [
                            Container(
                              ...
                              child: (response.data.sizeList.length != 0)
                                  ? Text(response.data.sizeList[index].toUpperCase(),
                                      style: AppTheme.subtitleopensans.copyWith(
                                          fontSize: 12,
                                          color: AppTheme.black_text,
                                          fontWeight: FontWeight.w200))
                            ...
                            Container(
                              ...
                              decoration: new BoxDecoration(
                                border: Border.all(
                                  color: AppTheme.light_text_color,
                                  width: 0.5,
                                ),
                                borderRadius: BorderRadius.circular(2),
                              ),
