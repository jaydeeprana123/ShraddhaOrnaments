             ...
             child: Row(
               ...
               children: [
                 ...
                 Container(
                   ...
                   decoration: BoxDecoration(
                     border: Border.all(color: AppTheme.bg, width: 0.5,),
                   ...
                   child: Image.asset('assets/images/home_pink.png',height: 20,color: AppTheme.black_800,),
                 ),
                 ...
                 Expanded(child: Container(
                   ...
                   child:Text(data.data.address,style: AppTheme.subtitleopensans.copyWith(color: AppTheme.black_text,fontSize: 14,fontWeight: FontWeight.w500),),
             ...
             child: Row(
               ...
               children: [
                 ...
                 Container(
                   ...
                   child: Image.asset('assets/images/contact_pink.png',height: 15,color: AppTheme.black_800,),
                 ),
                 ...
                 Expanded(child: Container(
                   ...
                   child:Text(data.data.phone,style: AppTheme.subtitleopensans.copyWith(color: AppTheme.black_text,fontSize: 14,fontWeight: FontWeight.w500),),
             ...
             child: Row(
               ...
               children: [
                 Container(
                   ...
                   padding: EdgeInsets.all(4),
                   child: Icon(Icons.mail,color: AppTheme.black_800,size: 22,),
                 ),
                 ...
                 Expanded(child: Container(
                   ...
                   child:Text(data.data.email,style: AppTheme.subtitleopensans.copyWith(color: AppTheme.black_text,fontSize: 14, fontWeight: FontWeight.w500),),
           ...
           Row(
             ...
             children: [
               ...
               Container(
                 ...
                 padding: EdgeInsets.all(4),
                 child: Image.asset('assets/images/time_pink.png',height: 20,color: AppTheme.black_800,),
               ),
              ...
              // SizedBox(width: 15,),
               ...
               Expanded(
                 child: Container(
                   ...
                   child:Text("Monday to Saturday\n09:30 AM to 07:30 PM",style: AppTheme.subtitleopensans.copyWith(color: AppTheme.black_text,fontSize: 14, fontWeight: FontWeight.w500),),
