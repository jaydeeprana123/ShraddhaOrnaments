...
import '../widget/title_category_view_for_main_category_page.dart';

class HomePageWithCategories extends StatefulWidget {

  final VoidCallback onFlatButtonPressed;

  HomePageWithCategories({@required this.onFlatButtonPressed});

  @override
  HomePageWithCategoriesState createState() {
    return HomePageWithCategoriesState();
  }
}

class HomePageWithCategoriesState extends State<HomePageWithCategories>
                  ...
                  return Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          //             Align(
                          //               alignment: Alignment.center,
                          //               child: Text("Shop By Category".toUpperCase(),
                          ...
                          //                             });
                          //                           },
                          //                           child: TitleCategoryViewForMainCategoryPage(
                          //                             width: 120,
                          //                             height: 120,
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      ...
                      )?.then((value) =>  widget.onFlatButtonPressed());
                    },
                    child: Container(
                      margin: EdgeInsets.only(right: 8),
                      child: Card(
...
class CategoryView extends StatelessWidget {
  ...
  CategoryView(
      {Key key, @required this.bloc, @required this.animationController, @required this.onButtonPressed})
